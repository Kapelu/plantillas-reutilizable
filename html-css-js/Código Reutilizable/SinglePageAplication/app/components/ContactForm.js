export function ContactForm() {
	...
	$form.innerHTML = `
		...
		<input type="email" name="email" placeholder="Escribe tu email" title="Email incorrecto" pattern="^[a-zA-Z0-9]+([_.][a-zA-Z0-9]+)*@[a-zA-Z0-9-]+(\\.[a-zA-Z0-9-]+)*(\\.[a-zA-Z]{2,15})$" required>
