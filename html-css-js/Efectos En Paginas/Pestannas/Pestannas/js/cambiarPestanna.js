...
function cambiarPestanna(pestannas,pestanna) {
    ...
    $(document).ready(function(){
        // Muestra el contenido de la pestaña pasada como parametro a la funcion, cambia el color de la pestaña y aumenta el padding para que tape el borde superior del contenido que esta juesto debajo y se vea de este modo que esta seleccionada.
